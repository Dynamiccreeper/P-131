...
solor_system_planet_count={}
for planet_data in planet_data_rows:
  if solor_system_planet_count.get(planet_data[0]):
    solor_system_planet_count[planet_data[0]]+=1
  else:
    solor_system_planet_count[planet_data[0]]=1

max_solor_system=max(solor_system_planet_count,key=solor_system_planet_count.get)
print("solor system {} has maximum planets {}".format(max_solor_system,solor_system_planet_count[max_solor_system]))

koi_351_planets=[]
for planet_data in planet_data_rows:
  if max_solor_system==planet_data[11]:
